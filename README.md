...
## What? [![start with why](https://img.shields.io/badge/start%20with-why%3F-brightgreen.svg?style=flat)](http://www.ted.com/talks/simon_sinek_how_great_leaders_inspire_action)

Seytech React Project
...
1. Fork this repo and clone `git clone https://github.com/maratgaip/seytech-fixinity.git`
2. Move to the appropriate directory: `cd seytech-fixinity`.<br />
